...
println("testing and learning scala from scratch: ")
//while
var i = 0
while (i <= 10) {
  println(i)
...
//List throuh charecters
i = 0
var randLetters = "ABCDEFGHIJKLMNOPQRSTUVW"
