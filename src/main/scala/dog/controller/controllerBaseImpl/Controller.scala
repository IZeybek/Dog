...
class Controller @Inject()(var board: BoardTrait) extends ControllerTrait {
  ...
  override def createNewBoard: Unit = {
    board.getBoardMap.size match {
      case 1 => board = injector.instance[BoardTrait](Names.named("tiny"))
      case 4 => board = injector.instance[BoardTrait](Names.named("small"))
      case 9 => board = injector.instance[BoardTrait](Names.named("normal"))
      case _ =>
    }
  }
